...
public final class Machines {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new ResourceSynthesizer(Groups.ADVANCED_MACHINES, RESOURCE_SYNTHESIZER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                Materials.IRON_SINGULARITY, Materials.COAL_SINGULARITY, SlimefunItems.REINFORCED_ALLOY_INGOT,
                Materials.IRON_SINGULARITY, Materials.REDSTONE_SINGULARITY, SlimefunItems.REDSTONE_ALLOY,
                Materials.DIAMOND_SINGULARITY, Materials.COAL_SINGULARITY, SlimefunItems.CARBONADO,
                Materials.GOLD_SINGULARITY, Materials.EMERALD_SINGULARITY, SlimefunItems.BLISTERING_INGOT_3,
                Materials.COPPER_SINGULARITY, Materials.ZINC_SINGULARITY, SlimefunItems.ELECTRO_MAGNET,
                Materials.IRON_SINGULARITY, Materials.QUARTZ_SINGULARITY, SlimefunItems.SOLAR_PANEL
        ...
        RandomizedItemStack twoDust = new RandomizedItemStack(
                CustomItemStack.create(SlimefunItems.COPPER_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.ZINC_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.TIN_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.ALUMINUM_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.LEAD_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.SILVER_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.GOLD_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.IRON_DUST.item(), 2),
                CustomItemStack.create(SlimefunItems.MAGNESIUM_DUST.item(), 2)
        );
        ...
        RandomizedItemStack sixtyFourDust = new RandomizedItemStack(
                CustomItemStack.create(SlimefunItems.COPPER_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.ZINC_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.TIN_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.ALUMINUM_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.LEAD_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.SILVER_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.GOLD_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.IRON_DUST.item(), 64),
                CustomItemStack.create(SlimefunItems.MAGNESIUM_DUST.item(), 64)
        );
        ...
        new MachineBlock(Groups.ADVANCED_MACHINES, COBBLE_PRESS, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                Materials.MACHINE_PLATE.item(), Materials.COBBLE_3.item(), Materials.MACHINE_PLATE.item()
        }).addRecipe(CustomItemStack.create(Materials.COBBLE_1.item(), 8), new ItemStack(Material.COBBLESTONE, 64))
                .addRecipe(CustomItemStack.create(Materials.COBBLE_2.item(), 8), CustomItemStack.create(Materials.COBBLE_1.item(), 64))
                .addRecipe(CustomItemStack.create(Materials.COBBLE_3.item(), 8), CustomItemStack.create(Materials.COBBLE_2.item(), 64))
                .addRecipe(CustomItemStack.create(Materials.COBBLE_4.item(), 8), CustomItemStack.create(Materials.COBBLE_3.item(), 64))
                .addRecipe(CustomItemStack.create(Materials.COBBLE_5.item(), 8), CustomItemStack.create(Materials.COBBLE_4.item(), 64))
        ...
        new MachineBlock(Groups.ADVANCED_MACHINES, INGOT_FORMER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                SlimefunItems.ELECTRIC_INGOT_FACTORY_2.item(), SlimefunItems.ELECTRIC_INGOT_FACTORY_2.item(), SlimefunItems.ELECTRIC_INGOT_FACTORY_2.item(),
                Materials.MACHINE_CIRCUIT.item(), Materials.MACHINE_CORE.item(), Materials.MACHINE_CIRCUIT.item(),
        }).addRecipe(CustomItemStack.create(SlimefunItems.COPPER_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.COPPER_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.ZINC_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.ZINC_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.TIN_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.TIN_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.ALUMINUM_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.ALUMINUM_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.LEAD_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.LEAD_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.SILVER_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.SILVER_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.GOLD_24K.item(), 1), CustomItemStack.create(SlimefunItems.GOLD_DUST.item(), 8))
                .addRecipe(new ItemStack(Material.IRON_INGOT, 4), CustomItemStack.create(SlimefunItems.IRON_DUST.item(), 8))
                .addRecipe(CustomItemStack.create(SlimefunItems.MAGNESIUM_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.MAGNESIUM_DUST.item(), 8))
        ...
        new MachineBlock(Groups.INFINITY_CHEAT, INFINITY_INGOT_FORMER, InfinityWorkbench.TYPE, new ItemStack[] {
                ...
                Materials.VOID_INGOT.item(), Materials.INFINITE_INGOT.item(), INGOT_FORMER.item(), INGOT_FORMER.item(), Materials.INFINITE_INGOT.item(), Materials.VOID_INGOT.item(),
                Materials.VOID_INGOT.item(), Materials.VOID_INGOT.item(), Materials.VOID_INGOT.item(), Materials.VOID_INGOT.item(), Materials.VOID_INGOT.item(), Materials.VOID_INGOT.item(),
        }).addRecipe(CustomItemStack.create(SlimefunItems.COPPER_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.COPPER_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.ZINC_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.ZINC_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.TIN_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.TIN_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.ALUMINUM_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.ALUMINUM_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.LEAD_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.LEAD_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.SILVER_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.SILVER_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.GOLD_24K.item(), 10), CustomItemStack.create(SlimefunItems.GOLD_DUST.item(), 64))
                .addRecipe(new ItemStack(Material.IRON_INGOT, 32), CustomItemStack.create(SlimefunItems.IRON_DUST.item(), 64))
                .addRecipe(CustomItemStack.create(SlimefunItems.MAGNESIUM_INGOT.item(), 32), CustomItemStack.create(SlimefunItems.MAGNESIUM_DUST.item(), 64))
                .ticksPerOutput(1).energyPerTick(7200).register(plugin);
        ...
        new MachineBlock(Groups.ADVANCED_MACHINES, DECOMPRESSOR, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                ...
                .addRecipe(CustomItemStack.create(Materials.COBBLE_4.item(), 8), Materials.COBBLE_5.item())
                .addRecipe(CustomItemStack.create(Materials.COBBLE_3.item(), 8), Materials.COBBLE_4.item())
                .addRecipe(CustomItemStack.create(Materials.COBBLE_2.item(), 8), Materials.COBBLE_3.item())
                .addRecipe(CustomItemStack.create(Materials.COBBLE_1.item(), 8), Materials.COBBLE_2.item())
