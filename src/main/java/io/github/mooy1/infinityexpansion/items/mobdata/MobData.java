...
public final class MobData {
    ...
    public static void setup(InfinityExpansion plugin) {
        ...
        new MobDataCard(WITHER, MobDataTier.MINI_BOSS, new ItemStack[] {
                ...
                CustomItemStack.create(SlimefunItems.WITHER_PROOF_OBSIDIAN.item(), 64), EMPTY_DATA_CARD.item(), CustomItemStack.create(SlimefunItems.WITHER_PROOF_OBSIDIAN.item(), 64),
                CustomItemStack.create(Materials.VOID_INGOT.item(), 4), CustomItemStack.create(SlimefunItems.WITHER_ASSEMBLER.item(), 4), CustomItemStack.create(Materials.VOID_INGOT.item(), 4)
        ...
        new MobDataCard(ENDER_DRAGON, MobDataTier.BOSS, new ItemStack[] {
                new ItemStack(Material.END_CRYSTAL, 64), CustomItemStack.create(Materials.VOID_INGOT.item(), 32), new ItemStack(Material.CHORUS_FLOWER, 64),
                SlimefunItems.INFUSED_ELYTRA.item(), EMPTY_DATA_CARD.item(), new ItemStack(Material.DRAGON_HEAD, 1),
                CustomItemStack.create(SlimefunItems.ENDER_LUMP_3.item(), 64), CustomItemStack.create(Materials.VOID_INGOT.item(), 32), new ItemStack(Material.DRAGON_BREATH, 64)
